...
class RttmyaCard extends StatefulWidget {
  ...
  @override
  State<RttmyaCard> createState() => _RttmyaCardState();
}

class _RttmyaCardState extends State<RttmyaCard> {
  @override
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.symmetric(
                  vertical: widget.cardSpacingVertical, horizontal: 30),
              child: Material(
